...
const App = () => {
  const users = [
    {
      img: 'https://plus.unsplash.com/premium_photo-1661583687357-f047d7f7b399?q=80&w=435&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      intro: '',
      color: 'royalblue',
      tag: 'Satisfied'
    },
    ...
    {
      img: 'https://plus.unsplash.com/premium_photo-1664474834472-6c7d1e3198e2?q=80&w=869&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      intro: '',
      color: 'black',
      tag: 'Average'
    }
